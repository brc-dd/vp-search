...
| ---------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| Algolia (DocSearch schema)   | `hierarchy[type]` highlighted; ancestors above it                      | `_snippetResult.content` via `fromTagged`                                                                 | `url` (absolute → rewrite)         | `nbHits` + `exhaustiveNbHits`         | send sentinel tags; `_highlightResult.hierarchy` omits null levels                                                                             |
